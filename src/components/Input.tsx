  ...
  return (
    <div className="relative z-0 w-full mb-6 group">
      <input
        type={type}
        id={field}
        className="block py-2.5 px-2 w-full text-sm text-gray-900 bg-transparent border-2 rounded-sm border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-secondary-bg2 peer"
        placeholder=" "
